...
urlpatterns = [
    ...
    path("category-all/",views.allcategory,name="category-all"),
    ...
    path('address/<int:pk>',views.updateAddress.as_view(),name="updateAddress"),
    ...
    path('password_change/',auth_view.PasswordChangeView.as_view(template_name="app/changepassword.html",form_class=MyPasswordChangeForm,success_url='/passwordchangedone'),name="passwordchange"),
...
admin.site.site_index_title="Ecommerce"
