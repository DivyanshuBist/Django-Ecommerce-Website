# Generated by Django 4.1.3 on 2022-11-19 11:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='product',
            name='category',
            field=models.CharField(choices=[('CR', 'Curd'), ('ML', 'Milk'), ('GH', 'Ghee'), ('LS', 'Lassi'), ('MS', 'Milkshake'), ('PN', 'Paneer'), ('CZ', 'Cheese'), ('IC', 'Ice-creams')], max_length=2),
        ),
